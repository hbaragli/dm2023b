...
PARAM$train$oversampling <- 5L
#  22000 duplica casi la totalidad de los casao BAJA+1 BAJA+2 en los meses de entrenamiento

PARAM$train$semilla <- 989761 # cambiar por su propia semilla  !!!
